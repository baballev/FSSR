...
if __name__ == '__main__': # To directly execute this file out of the evaluation.py process
    image_nb, duration, speed = speedMetric('E:/Programmation/Python/HArchiver/dataset/yande_eval/', 'E:/Programmation/Python/HArchiver/benchmark/tmp/speed/', 200, 'E:/Programmation/Python/HArchiver/weights/kona_factor=2_PERCEPTION_FSRCNN21_12epochs.pth', 'cpu', batch_size=5, network='FSRCNN21')
