...
if __name__ == "__main__":
    ...
    parser.add_argument('--learning_rate', default=0.00001, type=float, help="Learning rate for training with Adam optimizer. Only for 'meta_train' & 'meta_upscale' mode.")
