...
from FSSR import meta_train, finetuneTrain, MAMLupscale, model_train
from evaluation import evaluation

## Parser
if __name__ == "__main__":
    parser = ArgumentParser()
    parser.add_argument('--mode', default='meta_train', choices=['meta_train', 'meta_upscale', 'finetune_train', 'evaluation', 'upscale_video', 'model_train'])
