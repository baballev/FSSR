...
from FSSR import train, upscale
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input', default='../dataset/FSSR/DIV2K/DIV2K_valid_HR/', help="Path to the directory containing the images to upscale. Only used for 'upscale' & 'evaluation' mode.")
    ...
    parser.add_argument('--network_name', default='AutoEncoder20', choices=[''], help="Indicates which network is being used.")
    ...
    parser.add_argument('--save_weights', default='./weights/SRweights_10epochs.pth', help="Path to save the weights after training (.pth). Only for 'train' mode.")
    ...
    parser.add_argument('--meta_learning_rate', default=0.001, help="Learning rate of the meta training.")
